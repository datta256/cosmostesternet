...
const (
	Query_Params_FullMethodName   = "/testernet.assetidentity.Query/Params"
	Query_Asset_FullMethodName    = "/testernet.assetidentity.Query/Asset"
	Query_AssetAll_FullMethodName = "/testernet.assetidentity.Query/AssetAll"
)
