...
import (
	...
	assetidentitysimulation "testernet/x/assetidentity/simulation"
	"testernet/x/assetidentity/types"
)

// avoid unused import issue
var (
	_ = assetidentitysimulation.FindAccount
	_ = rand.Rand{}
	_ = sample.AccAddress
	_ = sdk.AccAddress{}
...
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	...
	assetidentityGenesis := types.GenesisState{
	...
	simState.GenState[types.ModuleName] = simState.Cdc.MustMarshalJSON(&assetidentityGenesis)
}
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		assetidentitysimulation.SimulateMsgCreateAsset(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		assetidentitysimulation.SimulateMsgUpdateAsset(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		assetidentitysimulation.SimulateMsgDeleteAsset(am.accountKeeper, am.bankKeeper, am.keeper),
	))
